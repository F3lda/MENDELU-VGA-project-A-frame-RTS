AFRAME.registerPrimitive('a-barracks', {
    defaultComponents: {
        'a-primitive': {origin: '0 2.4 0', data: `
            <!-- barracks -->
            <a-entity barracks ammo-body="type: static; angularFactor: 0 0 0; mass: 40; emitCollisionEvents: true;" position="-12 5 -8" scale="4 4 4" rotation="0 180 0">
              <a-entity class="clickable" gltf-model="#barracks" log-gltf-animations ammo-shape="type: hull;" position="0 -0.85 0" rotation="0 0 0" scale="1 1 1"></a-entity>
