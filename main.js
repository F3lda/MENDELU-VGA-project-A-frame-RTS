...
document.querySelector('#app').innerHTML = `
    ...
    <a-scene cursor="rayOrigin: mouse" raycaster="objects: .clickable">
      ...
      <!-- Character -->
      <a-entity character class="unit clickable obstacle" dynamic-body="mass: 1; angularDamping: 1; shape: box;" position="-2 0.4 -3">
      ...
      <!--  ground --> <a-box nav-mesh class="clickable" id="navmesh" static-body="friction: 0;" position="0 0 -2" width="30" height="0.2" depth="10" material="src: #grass; repeat: 1 1;" shadow="receive: true"></a-box> 
