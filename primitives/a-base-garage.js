AFRAME.registerPrimitive('a-base-garage', {
    defaultComponents: {
        'a-primitive': {origin: '0 1.6 0', data: `
            <!-- base garage -->
            <a-entity scale="3.5 3.5 3.5">
                <a-entity ammo-body="type: static; angularFactor: 0 0 0; mass: 40; emitCollisionEvents: true;" position="0 0 0" scale="3 3 3" rotation="0 180 0">
                    <a-entity gltf-model="#garage" log-gltf-animations ammo-shape="type: hull;" position="0.01 -0.06 0.04" rotation="0 0 0" scale="1 1 1"></a-entity>
                </a-entity>
                <a-entity ammo-body="type: static; angularFactor: 0 0 0; mass: 40; emitCollisionEvents: true;" position="1.5 0.12 0" scale="0.5 0.5 0.5" rotation="0 180 0">
