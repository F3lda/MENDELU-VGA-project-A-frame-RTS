AFRAME.registerPrimitive('a-dumptruck', {
    defaultComponents: {
        'a-primitive': {data: `
            <!-- Dumptruck -->
            <a-entity character dumptruck class="selectable" ammo-body="type: dynamic; angularFactor: 0 0 0; mass: 40; emitCollisionEvents: true;" position="-10 5 -3" scale="0.35 0.35 0.35" rotation="0 0 0">
